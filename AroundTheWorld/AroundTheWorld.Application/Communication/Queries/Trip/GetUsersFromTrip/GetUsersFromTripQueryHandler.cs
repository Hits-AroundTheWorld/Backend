...
{
    public class GetUsersFromTripQueryHandler : IRequestHandler<GetUsersFromTripQuery, IQueryable<GetUsersFromTripInfoDTO>>
    {
        ...
        public async Task<IQueryable<GetUsersFromTripInfoDTO>> Handle(GetUsersFromTripQuery request, CancellationToken cancellationToken)
        {
